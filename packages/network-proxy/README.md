this tiny library helps us (Sonarly folks) to create proxy objects for fetch,
XHR and beacons for proper request tracking in @Sonarly/tracker and Spot extension.

example usage:
```
import createNetworkProxy from '@Sonarly/network-proxy';
