...
- use separate library to handle network requests ([@Sonarly/network-proxy](https://www.npmjs.com/package/@Sonarly/network-proxy))
...
**(Compatible with Sonarly v1.11.0+ only)**
...
**(Compatible with Sonarly v1.10.0+ only)**
